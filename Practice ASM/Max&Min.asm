...
start:	mov si, 0		; si register to traverse through array indexs
...
maxnum:	mov bl, al		; Store al in bl
	jmp loop1

minnum:	mov cl, al		; Store al in cl
	jmp loop1

exit:	mov [max], bl		; Store final result in max variable
